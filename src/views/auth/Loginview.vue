        ...
        <div class="login-card p-6 sm:p-8">
          ...
          <form v-else @submit.prevent="handleRegister" class="space-y-5">
            ...
            <div class="field">
              ...
              <input v-model="registerForm.phone" type="text" placeholder="2221234567" required class="field-input" />
            </div>
            <div class="field">
              <label class="field-label">
                <svg class="field-label-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <div class="max-w-md mx-auto px-6 py-6">
        <div class="flex flex-col items-center gap-4">
          ...
          <div class="flex items-center gap-2 text-xs px-3 py-1.5 rounded-full"
            ...
            <svg class="w-3.5 h-3.5" style="color: var(--rose-primary);" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
              <path stroke-linecap="round" stroke-linejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
            </svg>
            <span style="color: var(--text-secondary);">{{ CONTACT_PHONE }}</span>
          </div>
        </div>
      </div>
    </footer>
