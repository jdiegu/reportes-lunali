    ...
    >
      <div v-if="preview" class="relative">
        ...
        <button
          ...
          class="absolute top-2 right-2 w-7 h-7 rounded-full flex items-center justify-center transition-colors shadow-sm"
        ...
        <div class="absolute bottom-0 left-0 right-0 px-3 py-1.5" style="background: linear-gradient(transparent, rgba(0,0,0,0.5));">
          <p class="text-xs truncate text-white">{{ fileName }}</p>
        </div>
      </div>
